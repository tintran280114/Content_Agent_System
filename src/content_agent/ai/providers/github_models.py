"""GitHub Models adapter via its OpenAI-compatible inference endpoint."""
...
class GitHubModelsProvider(StructuredProvider):
    provider_name: Literal["github_models"] = "github_models"
    ...
    def __init__(
        ...
        *,
        ...
        if client is None and not api_key:
            raise missing_credential(self.provider_name, model, "GITHUB_MODELS_TOKEN")
        ...
        *,
        ...
        return ProviderResponse(
            ...
            metadata=metadata(
                ...
                provider_sdk=sdk_version("openai"),
